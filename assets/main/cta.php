            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-7 col-md-8 col-sm-10 text-center text-md-left sm-margin-30px-bottom">
                        <h4 class="alt-font font-weight-600 text-white mb-0">Meld je nu ook aan door op de knop hier naast te klikken.</h4>
                    </div>
                    <div class="col-12 col-xl-5 col-md-4 text-center text-md-right">
                        <a href="https://www.petitie24.nl/petitie/3909/over-beautyfilters-moet-een-watermerk-komen" target="_blank" class="btn btn-large btn-gradient-shamrock-green-light-orange">Naar petitie</a>
                    </div>
                </div>
            </div>
        </section>
