        <!-- start section -->
        <section class="big-section wow animate__fadeIn" id="partners">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 text-center text-md-left sm-margin-30px-bottom">
                    <h5> Wij van <span style="background-color: #FFBD59; color:#fff;" class="heading">&nbsp;Filters4Fun&nbsp;</span> willen de mentale gezondheid van jongeren verbeteren. </h5>
                    <p>
                ...
                <div class="row row-cols-1 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 client-logo-style-01 align-items-center margin-7-half-rem-top sm-margin-5-rem-top">
                    ...
                    <div class="col text-center margin-30px-bottom sm-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.1s" >
                        <div class="client-box padding-15px-all border border-color-dark-gray">
                            <a href="#"><img class="client-box-image" src="images/logos/Erasmus.png" alt="Erasmus" /></a>
                        </div>
                    </div>
                    ...
                    <div class="col text-center margin-30px-bottom sm-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.2s">
                        <div class="client-box padding-15px-all border border-color-dark-gray">
                            <a href="#"><img class="client-box-image" src="images/logos/ggz.png" alt="ggz" /></a>
                        </div>
                    </div>
                    <!-- end client logo item -->
                    <!-- start client logo item -->
                    <div class="col text-center margin-30px-bottom sm-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.3s">
                        <div class="client-box padding-15px-all border border-color-dark-gray">
                            <a href="#"><img class="client-box-image" src="images/logos/hersenstichting.png" alt="hersenstichting" /></a>
                        </div>
                    </div>
                    <!-- end client logo item -->
                    <!-- start client logo item -->
                    <div class="col text-center margin-30px-bottom sm-margin-15px-bottom wow animate__fadeIn" data-wow-delay="0.4s">
                        <div class="client-box padding-15px-all border border-color-dark-gray">
                            <a href="#"><img class="client-box-image" src="images/logos/youz.png" alt="Youz" /></a>
                        </div>
                    </div>
                    <!-- end client logo item -->
                </div>
